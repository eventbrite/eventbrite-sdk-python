# -*- coding: utf-8 -*-
"""
Last Generated: 2020-10-03 21:59:58.239964

This module probably should have been autogenerated from the Eventbrite API
documentation, but it wasn't.
"""
...
class AccessMethodsMixin(object):
    ...
    def get_organization_owned_events(self, id, **data):
        """
        GET /organizations/:id/owned_events/
        Returns a paginated response of :format:`events <event>`, under
        the key ``events``, of all events the user owns (i.e. events they are organising)

        """

        return self.get("/organizations/{0}/owned_events/".format(id), data=data)
    ...
    def get_organization_organizers(self, id, **data):
        """
        GET /organizations/:id/organizers/
    ...
    def get_organization_owned_event_attendees(self, id, **data):
        """
        GET /organizations/:id/owned_event_attendees/
        ...
        (events that would be returned from ``/organizations/:id/owned_events/``)

        """

        return self.get("/organizations/{0}/owned_event_attendees/".format(id), data=data)

    def get_organization_owned_event_orders(self, id, **data):
        """
        GET /organizations/:id/owned_event_orders/
        Returns a paginated response of :format:`orders <order>`, under
        ...
        return self.get("/organizations/{0}/owned_event_orders/".format(id), data=data)

    def get_organization_contact_lists(self, id, **data):
        """
        GET /organizations/:id/contact_lists/
        Returns a list of :format:`contact_list` that the user owns as the key
        ``contact_lists``.

        """

        return self.get("/organizations/{0}/contact_lists/".format(id), data=data)

    def post_organization_contact_lists(self, id, **data):
        """
        POST /organizations/:id/contact_lists/
        Makes a new :format:`contact_list` for the user and returns it as
        ``contact_list``.

        """

        return self.post("/organizations/{0}/contact_lists/".format(id), data=data)

    def get_organization_contact_list(self, id, contact_list_id, **data):
        """
        GET /organizations/:id/contact_lists/:contact_list_id/
        Gets a user's :format:`contact_list` by ID as ``contact_list``.

        """

        return self.get("/organizations/{0}/contact_lists/{1}/".format(id,contact_list_id), data=data)

    def post_organization_contact_list(self, id, contact_list_id, **data):
        """
        POST /organizations/:id/contact_lists/:contact_list_id/
        Updates the :format:`contact_list` and returns it as ``contact_list``.

        """

        return self.post("/organizations/{0}/contact_lists/{1}/".format(id,contact_list_id), data=data)

    def delete_organization_contact_list(self, id, contact_list_id, **data):
        """
        DELETE /organizations/:id/contact_lists/:contact_list_id/
        Deletes the contact list. Returns ``{"deleted": true}``.

        """

        return self.delete("/organizations/{0}/contact_lists/{1}/".format(id,contact_list_id), data=data)

    def get_organization_contact_lists_contacts(self, id, contact_list_id, **data):
        """
        GET /organizations/:id/contact_lists/:contact_list_id/contacts/
        Returns the :format:`contacts <contact>` on the contact list
        as ``contacts``.

        """

        return self.get("/organizations/{0}/contact_lists/{1}/contacts/".format(id,contact_list_id), data=data)

    def post_organization_contact_lists_contacts(self, id, contact_list_id, **data):
        """
        POST /organizations/:id/contact_lists/:contact_list_id/contacts/
        ...
        return self.post("/organizations/{0}/contact_lists/{1}/contacts/".format(id,contact_list_id), data=data)

    def delete_organization_contact_lists_contacts(self, id, contact_list_id, **data):
        """
        DELETE /organizations/:id/contact_lists/:contact_list_id/contacts/
        Deletes the specified contact from the contact list.
        Returns ``{"deleted": true}``.

        """

        return self.delete("/organizations/{0}/contact_lists/{1}/contacts/".format(id,contact_list_id), data=data)
